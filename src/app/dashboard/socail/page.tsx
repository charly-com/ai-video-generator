      ...
      <div className="rounded-2xl p-4 flex gap-3" style={{ background: 'rgba(249,115,22,0.07)', border: '1px solid rgba(249,115,22,0.2)' }}>
        ...
        <div>
          ...
          <p className="text-[12px] leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            Each platform needs API keys in your <code className="text-orange-400">.env.local</code>. See the README for step-by-step setup for each platform's developer console.
          </p>
          <a href="https://github.com/yourname/viralkit#api-keys-setup" target="_blank" rel="noopener"
            className="text-[12px] text-orange-400 flex items-center gap-1 mt-2 hover:text-orange-300">
